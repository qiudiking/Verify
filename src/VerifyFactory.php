...
class VerifyFactory {
	...
	/**
	 * @return \AtServer\Base64ImageVerify
	 */
	...
	/**
	 * @return \AtServer\FormHashVerify
	 */
	...
	/**
	 * @return \AtServer\MobileNewsVerify
	 */
	...
	/**
	 * @return \AtServer\MobileCodeVerify
	 */
